...
exports.skillCheckNotEmpty = skillCheckNotEmpty;
exports.skillCheckMinLength = skillCheckMinLength;
exports.skillCheckKeywords = skillCheckKeywords;
exports.skillLintTypeScript = skillLintTypeScript;
exports.skillRunAllChecks = skillRunAllChecks;
exports.skillFormatTestReport = skillFormatTestReport;
// ─────────────────────────────────────────────
// SKILLS DO TESTADOR
// Funções auxiliares de validação
// ─────────────────────────────────────────────
// Valida se o resultado não está vazio ou inválido
function skillCheckNotEmpty(result) {
...
function skillCheckMinLength(result, minChars = 50) {
...
function skillCheckKeywords(result, requirements) {
    const failures = [];
...
function skillLintTypeScript(code) {
    const failures = [];
...
function skillFormatTestReport(report) {
    if (report.status === 'approved') {
        return `✓ APROVADO — ${report.summary}`;
    }
    const lines = [`✗ FALHOU — ${report.summary}`];
